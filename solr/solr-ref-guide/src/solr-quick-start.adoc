...
<div role="tabpanel" class="tab-pane active" id="json">
    <h3>JSON Format</h3>
    <h4>Input</h4>
    <pre class="pygments highlight"> <code data-lang="bash">bin/post -c gettingstarted example/exampledocs/books.json</code> </pre>
    <h4>Output</h4>
    <div class="listingblock"><div class="content"><pre class="pygments highlight">
    <code data-lang="bash">
...
Time spent: 0:00:00.493</code></pre></div></div>
</div>
